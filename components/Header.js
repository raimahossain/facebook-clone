        ...
        <div className="sticky top-0 z-50 bg-white flex items-center p-2 lg:px-5 shadow-md">
            ...
            <div className="flex justify-center flex-grow">
                <div className="flex space-x-6 md:space-x-2">
                    ...
                    <HeaderIcon className="" Icon={FlagIcon}/>
                    <HeaderIcon className="" Icon={PlayIcon}/>
                    <HeaderIcon className="" Icon={ShoppingCartIcon}/>
                    <HeaderIcon className="" Icon={UserGroupIcon}/>
                </div>
            </div>
            ...
            <div className="flex items-center sm:space-x-2 justify-end">
                <Image
                    ...
                    src={session.user.image}    //uses the image of user logged in
                    width="40"
                    height="40"
                    layout="fixed"
                />
